...
![Countdown](https://img.shields.io/badge/%20Anticipated%20Launch%20-857%20days-blue)
...
Example 8: [511 imaging](https://github.com/cositools/cosipy/tree/main/docs/tutorials/image_deconvolution/511keV/ScAttBinning) <br />
...
- **The image deconvolution does not account for Earth occultation and SAA passage.** This only applies when calculating the point source response on the fly. However, another option is to use a precomputed point source response file, in which case Earth occultation and SAA passage are accounted for. 
