...
**Input Models:** <br />
The GRBs occur randomly within the orientation file, with their positions chosen such that they have incidence angles under $60^\circ$. The spectra are described with Band functions, and the parameters are based on fits to GBM data. Likewise, the lightcurves are also from GBM data. The fluxes were chosen such that some GRBs have a minimum detectable polarization (MDP) below their polarization fraction, and some have a MDP above. All input models can be found [here](https://github.com/cositools/cosi-sim/tree/main/cosi_sim/Source_Library/DC3/sources/GRBs).

The models are specified below, including the position in detector coordinates, the flux, the polarization fraction (PF), and the polarization angle (PA) given in IAU convention. We also provide burst times, which is needed for the analysis:
- bn081207680: zenith = $5^\circ$, azimuth = $15^\circ$, flux = 0.0785 ph/cm2/s, PF = 0, PA = $0^\circ$, t = 1836496300.0 s
- bn090424592: zenith = $20^\circ$, azimuth = $185^\circ$, flux = 244.8000 ph/cm2/s, PF = 0.1, PA = $110^\circ$, t = 1837507002.0 s
- bn100612726: zenith = $23^\circ$, azimuth = $295^\circ$, flux = 1.0236 ph/cm2/s, PF = 0.2, PA = $35^\circ$, t = 1839617230.0 s
- bn110605183: zenith = $40^\circ$, azimuth = $315^\circ$, flux = 1.5570 ph/cm2/s, PF = 0.3, PA = $50^\circ$, t = 1841896404.0 s
- bn131122490: zenith = $0^\circ$, azimuth = $346^\circ$, flux = 0.9651 ph/cm2/s, PF = 0.4, PA = $175^\circ$, t = 1842123855.0 s
- bn140329295: zenith = $8^\circ$, azimuth = $95^\circ$, flux = 0.2418 ph/cm2/s, PF = 0.5, PA = $95^\circ$, t = 1843753776.0 s
- bn161004964: zenith = $15^\circ$, azimuth = $84^\circ$, flux = 0.8569 ph/cm2/s, PF = 0.6, PA = $10^\circ$, t = 1845900508.0 s
- bn170405777: zenith = $60^\circ$, azimuth = $20^\circ$, flux = 0.5760 ph/cm2/s, PF = 0.7, PA = $160^\circ$, t = 1846666390.0 s
- bn180504136: zenith = $12^\circ$, azimuth = $213^\circ$, flux = 0.4181 ph/cm2/s, PF = 0.8, PA = $45^\circ$, t = 1847439100.0 s
- bn180703876: zenith = $25^\circ$, azimuth = $156^\circ$, flux = 0.3540 ph/cm2/s, PF = 0.9, PA = $25^\circ$, t = 1849427245.0 s
